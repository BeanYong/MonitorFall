package com.anasit.beanyong.monitorfall.view;
...
public class SlidingMenuView extends HorizontalScrollView {
    ...
    public SlidingMenuView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SlidingMenuView, 0, defStyle);
        mRightMargin = (int) ta.getDimension(R.styleable.SlidingMenuView_right_margin,
